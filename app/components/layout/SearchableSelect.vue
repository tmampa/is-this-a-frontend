...
<template>
  <div class="relative">
    ...
    <!-- Dropdown results -->
    <div 
      v-show="showDropdown && (filteredItems.length > 0 || searchQuery.length > 0)"
    ...
    >
      ...
      <div v-else-if="filteredItems.length === 0 && searchQuery.length > 0" class="p-3 text-center text-base-content/60">
      ...
      <div v-else>
        ...
        >
          ...
          <div v-if="getItemSubtitle(item)" class="text-sm text-base-content/60">
...
const filteredItems = computed(() => {
  ...
  const searchInKeys = props.searchKeys.length > 0 ? props.searchKeys : [props.displayKey];
